...
import { Heart, SlidersHorizontal, Loader2, Trash2 } from "lucide-react";
    ...
    async function fetchProducts() {
      try {
        ...
        const menProducts = data.filter((p: Product) => 
          p.category === 'men' || p.category === 'shirts' || p.category === 'pants' || p.category === 'jackets'
        );
        setProducts(menProducts.length > 0 ? menProducts : data);
      } catch (err) {
...
const handleDelete = async (productId: number) => {
  ...
  try {
    ...
    // Dynamic Route: matches /api/products/[id]
    ...
    // Remove product from state locally to update UI instantly
  ...
  const categories = [
    { id: 'all', name: 'All' },
    { id: 'shirts', name: 'Shirts & T-shirts' },
  ...
  const filteredAndSortedProducts = useMemo(() => {
    return products
      .filter(product => {
        ...
        if (priceRange === '1000-3000' && (price < 1000 || price > 3000)) return false;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl font-bold mb-4">Men's Section</h1>
          <p className="text-lg text-gray-300">Discover the latest trends in men's fashion</p>
        </div>
      </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm sticky top-4">
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  <option value="under1000">Under 1000 Birr</option>
                  <option value="1000-3000">1000 - 3000 Birr</option>
                  <option value="3000-5000">3000 - 5000 Birr</option>
                  <option value="above5000">Above 5000 Birr</option>
                </select>
              </div>
            </div>
          </aside>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredAndSortedProducts.map(product => (
                  ...
                  >
                    ...
                    <div className="px-4 pb-4 font-semibold text-gray-900 text-lg">
