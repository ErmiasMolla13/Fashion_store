  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        ...
        // Filter specifically for women's categories
        const womenProducts = data.filter((p: Product) =>
          ['women', 'dresses', 'tops', 'bottoms', 'outerwear', 'shoes', 'accessories'].includes(p.category)
        );
        setProducts(womenProducts.length > 0 ? womenProducts : data);
      } catch (err) {
  ...
  const filteredAndSortedProducts = useMemo(() => {
    return products
      .filter((product) => {
        ...
        if (priceRange === 'over3000' && price <= 3000) return false;
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-300">Discover the latest trends in women's fashion</p>
        </div>
      </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm sticky top-4">
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  <option value="1000to2000">1000 - 2000 Birr</option>
                  <option value="2000to3000">2000 - 3000 Birr</option>
                  <option value="over3000">Over 3000 Birr</option>
                </select>
              </div>
            </div>
          </aside>
